...
namespace Bank_System
{
    internal class Program
    {
        public static int Menu(List<string> choose)
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < choose.Count; i++)
                {
                    ...
                    if (index == i) Console.BackgroundColor = ConsoleColor.DarkBlue;
        ...
        static void Main()
        {
            CEO ceo = new CEO("Ibrahim", "Asadov", 19, "CEO", 10000, "Kapital");
            Bank bank = new("Kapital", 100000, 15000, ceo);
            Worker w1 = new Worker("Rustem", "Hesenli", 16, "Worker", 2500, "9:00", "17:30");
            Worker w2 = new Worker("Hesen", "Abdullayev", 18, "Worker", 2000, "9:00", "17:30");
            bank.addWorker(w1);
            bank.addWorker(w2);
            Manager manager = new Manager("Kamal", "Rehimov", 20, "Manager", 3500, "2 year");
            bank.addManager(manager);
            Client c1 = new("Mehemmed", "Quziyev", 26, "Client", 2000, "Baku, Ayna Sultanova 42.", "Koroglu Rehimov 45.");
            Client c2 = new("Merac", "Omarov", 24, "Client", 4000, "Baku, Bineqedi Koroglu 45.", "Koroglu Rehimov 45.");
            bank.addClient(c1);
            bank.addClient(c2);
